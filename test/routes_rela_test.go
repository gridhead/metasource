...
func TestRela_Init_Failure_ReadRelation_Misc_C400(t *testing.T) {
	...
	lookup.ReadRelation = func(vers *string, pack *home.PackUnit, repo *string, relation *string) ([]home.PackUnit, error) {
		return []home.PackUnit{}, errors.New("ReadRelation failed")
	}
